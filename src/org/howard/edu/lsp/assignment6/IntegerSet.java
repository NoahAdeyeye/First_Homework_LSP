...
public class IntegerSet {
    ...
    // Returns the largest item in the set; Throws IntegerSetException if the set is empty. 5 pts.
    ...
    // Returns the smallest item in the set; Throws IntegerSetException if the set is empty. 5 pts.
